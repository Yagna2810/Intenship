      ...
      <script src="index.js"> </script>
        ...
        <div class="masala-container">
            ...
            <div class="masala-item">
                ...
                <p id="price">500 GM - ₹535</p>
                <a href="kashmiri.html" id="View" class="change">View More</a>
            </div>
            <div class="masala-item">
                <img class="size" src="vasant-achar-masala_1.jpg" alt="vasant-achar-masala_1">
                <p id="name">ACHAR POWDER</p>
                <p id="price">500 GM - ₹300</p>
                <a href="achar.html" id="View" class="change">View More</a>
            </div>
